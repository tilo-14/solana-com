...
references to any payment. These memos are permanently recorded on-chain and
...
<Callout>
  ...
  payment concepts. See here, for similar payment flows using [Light Token](https://www.zkcompression.com/light-token/payments/overview).
</Callout>
