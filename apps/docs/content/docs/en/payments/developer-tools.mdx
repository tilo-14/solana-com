...
| Solana Keychain | Unified signing across Vault, Privy, Turnkey, AWS KMS, Fireblocks, GCP KMS, CDP, Para, Dfns | [GitHub](https://github.com/solana-foundation/solana-keychain) • [Crate](https://crates.io/crates/solana-keychain) |
...
Light Protocol Token API’s to reduce account creation cost for stablecoin rails. 
Learn more in the [documentation](https://www.zkcompression.com/light-token/payments/overview).

| Package | Description | Links |
| --- | --- | --- |
| @lightprotocol/compressed-token | Unified interface methods for tokens. | [npm](https://www.npmjs.com/package/@lightprotocol/compressed-token) |
| @lightprotocol/stateless.js | RPC Client | [npm](https://www.npmjs.com/package/@lightprotocol/stateless.js) |
...
| Light Token Skills     | Toolkit for Solana payments using Light Token                                | [GitHub](https://github.com/Lightprotocol/skills/tree/main/skills/payments-and-wallets) • [Docs](https://www.zkcompression.com/light-token/payments/overview) |
