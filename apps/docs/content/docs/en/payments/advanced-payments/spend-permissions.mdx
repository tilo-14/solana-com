...
<Callout type="info">
  Delegation works similarly with Light Token.
   Visit the [documentation](https://www.zkcompression.com/light-token/payments/overview) to learn more.
</Callout>
...
| [Spend Permission with Light Token](https://www.zkcompression.com/light-token/payments/overview)    | Spend permissions and payment flows with Light Token.                            |
